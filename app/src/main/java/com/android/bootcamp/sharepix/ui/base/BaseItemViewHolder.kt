package com.android.bootcamp.sharepix.ui.base
...
import com.android.bootcamp.sharepix.di.component.DaggerViewHolderComponent
...
import com.android.bootcamp.sharepix.utils.display.Toaster
...
abstract class BaseItemViewHolder<T : Any, VM : BaseItemViewModel<T>>(
    ...
    private fun buildViewHolderComponent() =
        DaggerViewHolderComponent
            .builder()
            .applicationComponent((itemView.context.applicationContext as SharePixApplication).applicationComponent)
